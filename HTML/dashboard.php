...
<body>
  <div class="dashboard-wrapper">
    ...
    <div class="calendar-header">
      <form action="" method="GET"><button type="submit" name="month" value="prev">←</button></form>
      <span>April 2025</span>
      <form action="" method="GET"><button type="submit" name="month" value="next">→</button></form>
    </div>
